...
namespace MyStack.Auth.Data.Migrations
{
    ...
    [Migration("20260731201840_HardeningIndexes")]
    partial class HardeningIndexes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyStack.Auth.Data.ApplicationRole", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("MyStack.Auth.Data.ApplicationUser", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("MyStack.Auth.Data.PermissionOverride", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("UserId", "Permission")
                        .IsUnique()
                        .HasDatabaseName("ix_permission_overrides_user_id_permission");

                    b.ToTable("permission_overrides", "auth");
                });
            ...
            modelBuilder.Entity("OpenIddict.EntityFrameworkCore.Models.OpenIddictEntityFrameworkCoreApplication", b =>
                {
                    ...
                    b.ToTable("oidc_applications", "auth");
                });
            ...
            modelBuilder.Entity("OpenIddict.EntityFrameworkCore.Models.OpenIddictEntityFrameworkCoreAuthorization", b =>
                {
                    ...
                    b.ToTable("oidc_authorizations", "auth");
                });
            ...
            modelBuilder.Entity("OpenIddict.EntityFrameworkCore.Models.OpenIddictEntityFrameworkCoreToken", b =>
                {
                    ...
                    b.HasIndex("CreationDate")
                        .HasDatabaseName("ix_oidc_tokens_creation_date");
                    ...
                    b.ToTable("oidc_tokens", "auth");
                });

            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("MyStack.Auth.Data.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("MyStack.Auth.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MyStack.Auth.Data.PermissionOverride", b =>
                {
                    b.HasOne("MyStack.Auth.Data.ApplicationUser", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_permission_overrides_users_user_id");
                });
